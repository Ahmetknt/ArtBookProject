package com.ahmetkanat.a11_artbook;
...
import com.ahmetkanat.a11_artbook.databinding.ActivityArtBinding;
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if(result){
                    ...
                    //permissions denied
                    Toast.makeText(ArtActivity.this,"Permissions needed!",Toast.LENGTH_LONG).show();
                }
            }
        });
